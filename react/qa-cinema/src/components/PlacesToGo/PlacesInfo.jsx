      ...
      <div className="container-fluid">
        <div className="row align-items-start">
          ...
          <div className=" indigo col-12 col-md-6 col-lg-4 mb-5">
            ...
            <div className='description'>Located in the heart of Tower Bridge, Indigo's Kitchen is a restaurant and bar with a spacious garden overlooking the Thames. Minutes away from London Bridge and Tower Hill, Indigo's Kitchen is the best spot for enjoying a lovely family meal, dinner for two or group outing. A menu with gluten-free, vegan and vegetarian options, makes us the best place for breakfast, lunch or dinner! A family friendly restaurant that emcompasses soul and vivacity not only in the atmosphere but also in the Kitchen (no pun intended!)
              <ReadMoreReadLess descriptionLength={70}>
                <i className="fa-solid fa-circle-info"></i>
                <br />
                Offers: Enjoy 15% of your cinema tickets at QA Cinema when you dine at Indigo's Kitchen between 12pm-4pm
                Enjoy 20% your cinema tickets at QA Cinema when you dine at Indigo's Kitchen between 4pm-8pm<br />
                Address: 12 St Katharine's Way, London E1W 1UN<br />
                Contact Details: IndigoKitchen@contactinfo.com<br />
                Telephone: 02087759863<br />
              </ReadMoreReadLess>
            </div>
          </div>
          <div className=" paradox col-12 col-md-6 col-lg-4 mb-5">
            ...
            <div className='description'>London's greatest Funfair is open for your family outing! Immersive yourself in all things fun, from attractions and entertainment to food and drink! Find us in Tower Bridge, near QA Cinema and Indigo's Kitchen.
              <ReadMoreReadLess descriptionLength={70}>
                <i className="fa-solid fa-circle-info"></i>
                <br />
                Offers: Buy 3 or more tickets for 15% off nearby attractions such as QA Cinema and Blues Kitchen.<br />
                Address: 17-29 St Katharine's Way, London E1W 1UN<br />
                Contact Details: ParadoxIsland@info.com<br />
                Telephone: 02086098432<br />
              </ReadMoreReadLess>
            </div>
          </div>
        </div>
